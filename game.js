var GAME_MANIFEST = {
	...
	fps: 60,
	landscape: !0,
	moreGames: "http://www.5you.cc"
}, GAME_CONFIG = {
	colors: {red: "255,0,0", green: "0,255,0", blue: "0,0,255", yellow: "255,255,0"},
	castle: {maxSkill: 50, hp: 5, towerColumns: 5}
};
...
GAME_CONFIG.castle.upgrade = {
	power: {cost: 1200, costRatio: DEFAULT_COST_RATIO, maxLevel: 38},
	goldPerViking: {cost: 700, costRatio: DEFAULT_COST_RATIO, maxLevel: 15},
	skillReload: {cost: 300, costRatio: DEFAULT_COST_RATIO, maxLevel: 25},
	towersCount: {cost: 2E3, costRatio: DEFAULT_COST_RATIO, maxLevel: 30},
	towersLevel: {cost: 1E3, costRatio: DEFAULT_COST_RATIO, maxLevel: 20},
	skill_red: {cost: 800, costRatio: DEFAULT_COST_RATIO, maxLevel: 20},
	skill_green: {cost: 800, costRatio: DEFAULT_COST_RATIO, maxLevel: 20},
	skill_blue: {
		cost: 800, costRatio: DEFAULT_COST_RATIO,
		maxLevel: 20
	},
	skill_yellow: {cost: 800, costRatio: DEFAULT_COST_RATIO, maxLevel: 20},
	cannons: {cost: 500, costRatio: DEFAULT_COST_RATIO, maxLevel: 25},
	attack: {cost: 1E3, costRatio: DEFAULT_COST_RATIO, maxLevel: 30},
	armor: {cost: 600, costRatio: DEFAULT_COST_RATIO, maxLevel: 30}
};
GAME_CONFIG.enemy = {};
...
var TTLoader = {
	...
	create: function (a, c, d, e) {
		...
		var f = window.ExternalAPI ? ExternalAPI.exec("getPreloaderURL") : "http://www.5you.cc/", g = "_blank";
...
var ExternalAPI = {
	type: "default", init: function () {
		...
		return "http://www.5you.cc/"
	}, getPreloaderURL: function () {
		return "http://www.5you.cc/"
	}, showCopyright: function () {
	}, showAds: function () {
		var a = window.location.href;
		if (0 == a.indexOf("http://www.5you.cc") ||
			0 == a.indexOf("https://www.5you.cc")) window.GoogleIMA ? GoogleIMA.show() : window.Leadbolt && Leadbolt.show()
	}
};
...
Tower.prototype.hit = function (a) {
	...
	if (0 >= this.hp && (this.die(), "function" == typeof this.onDie)) {
		console.log('die_________________________', GameData.money);
		console.log('die_____++++++++++++++_', Battle.castle.money);
		console.log()
		this.onDie(this)
...
Battle.prototype.onDefeat = function () {
	...
	console.log('cccccccccccccc', this.castle.money);
	document.getElementById('push-scores-btn').style.display = 'block';
	console.log(document.getElementById('push-scores-btn'))
	document.getElementById('push-scores-btn').addEventListener('click', function() {
		console.log(GameData.money+'{{{{{{{{{{{{{{{{{');

		var NebPay = require("nebpay");
		var nebPay = new NebPay();
		var to = "n1ky2tNkY5zdNNy2nUYXJ2auU6KDy7FZPE3";
		var value = "0";
		var callFunction = "save";
		var callArgs = '[\"' + GameData.money+ '\"]';
		//callArgs.push(game.score+"" )
...
function showUpgrades() {
	...
	console.log('AAAAAAAAAAAAAAAAAAAAAAA', GameData.money)
	...
	a.onposttick = function () {
		h.moneyText.write(GameData.money)
		console.log('BBBBBBBBBBBBBBBBB', GameData.money)
